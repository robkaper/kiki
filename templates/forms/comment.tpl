...
{if $user.id}
  <div class="comment" style="min-height: 0px;">
    <img class="social" style="background-image: url({$activeConnections.0.pictureUrl})" src="/kiki/img/services/{$activeConnections.0.serviceName}_16.png" alt="[{$activeConnections.0.userName}]" />
